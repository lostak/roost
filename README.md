...
- Download/Move Statements
  - Create a the following folders
  ```
  Commissions/
    Statements/
      2026/ 
  ...
  ```
- Pull Repository
  - Open **../Commissions/roost** in Powershell/Terminal by right clicking your file exploer in the roost folder and clicking Terminal
  - Type the following, press enter between each line
  ```
  git init
...
- Stop Roost
  - Close Terminal/Powershell with `ctl+c` or close the window
